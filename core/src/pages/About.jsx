        ...
        <div className="container">
          ...
          <div className="row content">
            <div className="col-md-5" data-aos="fade-right">
              <img src="assets/img/team/Kuwarjeet-Singh-200x300.jpeg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row content">
            <div className="col-md-5 order-1 order-md-2" data-aos="fade-left">
              <img src="assets/img/team/Harman%20arora.jpeg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row content">
            <div className="col-md-5" data-aos="fade-right">
              <img src="assets/img/team/Yashvi%20parwani.jpeg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row content">
            <div className="col-md-5 order-1 order-md-2" data-aos="fade-left">
              <img src="assets/img/team/Avleen%20kaur.jpg" className="img-fluid" alt="" />
            </div>
            <div className="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
              <h2>Avleen Kaur</h2>
              <h4><b>COORDINATOR & CO-FOUNDER</b></h4>
